...
export default function OurServices ()
{
    ...
    return (
            <div className="mx-auto w-full p-4 py-6 max-w-screen-xl">
                  ...
                  <OurServicesCard name="Our Services" description={aboutUsPoints}></OurServicesCard>
    ...
    return (
          <div className="grid grid-row-1 grid-cols-2 grid-flow-row items-center h-auto mx-8">
            ...
            <div className="relative flex flex-col items-start w-auto h-auto  p-12">
                <h1 className="mb-2 text-4xl">{name}</h1><hr className="w-20 h-0.5 bg-black mb-8"/>
                <h5 className="mb-6 text-md">
                    {
                     description.map((descPoints:any) => <li key={descPoints.line}>{descPoints.point}</li>)
                    }
                </h5>
